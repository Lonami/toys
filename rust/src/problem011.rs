...
fn mul(grid: &Vec<Vec<usize>>, mut i: i32, mut j: i32, di: i32, dj: i32) -> usize {
    let mut result = 1;
    for _ in 0..4 {
        i += di;
        j += dj;
...
fn solve() {
    ...
    let mut result = 0;
    let dimensions = 20;
    let dimensions4 = dimensions - 4;
    for i in 0..dimensions {
        for j in 0..dimensions {
            if i < dimensions4 {
                if j >= 4 {
                    // /
                    result = cmp::max(result, mul(&grid, i, j, 1, -1));
                }
                if j < dimensions4 {
                    // \
                    result = cmp::max(result, mul(&grid, i, j, 1, 1));
                    ...
                    // |
                    result = cmp::max(result, mul(&grid, i, j, 1, 0));
                }
            } else if j < dimensions4 {
                // -
                result = cmp::max(result, mul(&grid, i, j, 0, 1));
            }
        }
    }
