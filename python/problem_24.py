...
def problem_definition():
    return '''A permutation is an ordered arrangement of objects. For example, 3124 is one possible
...
print(''.join(str(i) for i in next(islice(permutations(range(10)), 999999, 1000000))))
