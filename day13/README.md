...
the **depth** of each layer and the **range** of the scanning area for the
...
you leave.) If you were to do this in the configuration above, marking your
...
packet entered the layer when its scanner was at the top when you entered
it. You are **not** caught in layer `1`, since the scanner moved into the
